...
public registros: any
  ...
  ngOnInit(): void {
    ...
    function quantVolunteersfiltered (array) {array.length} 
...
public filtrarApi(termo:string, campo:string):void{
  if(termo.trim() === ""){
    ...
    this.filtroPersonalizado.buscaPorFiltro(termo, campo)
    .then((resposta:VoluntaryModel[])=> this.filteredVolunteers = resposta)
